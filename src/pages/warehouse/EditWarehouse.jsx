...
const EditWarehouse = () => {
  ...
  const fetchPromotors = async () => {
    try {
      ...
      const response = await axios.get(`${(import.meta.env.DEV ? import.meta.env.VITE_BASE_URL : null) || 'https://admin.gmkart.com/proxy'}/api/admin/promotor`);
  ...
  const fetchWarehouse = async () => {
    try {
      setFetching(true);
      const response = await axios.get(`${(import.meta.env.DEV ? import.meta.env.VITE_BASE_URL : null) || 'https://admin.gmkart.com/proxy'}/api/admin/warehouse/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${(import.meta.env.DEV ? import.meta.env.VITE_BASE_URL : null) || 'https://admin.gmkart.com/proxy'}/api/admin/warehouse/${id}`, submitData);
