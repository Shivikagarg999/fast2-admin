...
import { Edit, Trash2, Plus, Package, X, Search, Eye, Truck, CreditCard } from "lucide-react";
...
const OnlinePay = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_BASE_URL || 'https://api.fast2.in'}/api/admin/orders/getonline?${params}`);
    ...
    const getPaymentStatusBadge = (status) => {
        const statusConfig = {
            ...
            partially_paid: { color: 'bg-orange-100 text-orange-800 dark:bg-orange-800 dark:text-orange-100', label: 'Partially Paid' }
        };
            ...
            <div className="max-w-7xl mx-auto p-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                    <div className="flex items-center mb-4 sm:mb-0">
                        ...
                        <span className="ml-3 px-2 py-1 text-xs bg-blue-100 dark:bg-blue-800 text-blue-600 dark:text-blue-300 rounded-full">
                                    ...
                                    <tr>
                                        <td colSpan={7} className="text-center py-8">
                                            <div className="flex items-center justify-center">
                                                ...
                                                <span className="ml-2 text-gray-500 dark:text-gray-400">Loading online payments...</span>
                                            </div>
                                        </td>
                                    </tr>
                                ) : orders.length === 0 ? (
                                    <tr>
                                        <td colSpan={7} className="text-center py-8">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <span className="text-gray-500 dark:text-gray-400">No online payments found.</span>
                                        ...
                                        <tr key={order._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div className="text-xs text-gray-500 dark:text-gray-400">
                                                    {order.walletDeduction > 0 && `Wallet: -${formatCurrency(order.walletDeduction)}`}
                                                </div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
                                    Online Payment Details - #{selectedOrder.orderId}
                                </h2>
                                <button
                                    onClick={closeModal}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p><strong>Total Amount:</strong> {formatCurrency(selectedOrder.finalAmount)}</p>
                                            {selectedOrder.walletDeduction > 0 && (
                                                <p><strong>Wallet Deduction:</strong> -{formatCurrency(selectedOrder.walletDeduction)}</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div key={index} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-500 dark:text-gray-400">Price: {formatCurrency(item.price)}</p>
                                                    </div>
                                                </div>
